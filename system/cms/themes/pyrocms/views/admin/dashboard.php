...
<div id="sortable">
	...
	<div class="one_full">
		...
		<section class="draggable title">
			<h4>This software is entirely the property of multipro softwares.  </h4>
		...
		<section id="quick_links" class="item ">
			<div class="content">
				<ul>
					<li> 
					<h4>Advert Software System.</h4>
					<h6>Access the menu to work on this software.</h6>
						<a class="tooltip-s" title="<?php echo lang('cp:manage_comments') ?>" href="<?php echo site_url('admin/comments') ?>">
							Multipro Software System.
	...
	<!-- Begin Quick Links -->
	<?php if (isset($do_not_show) AND $theme_options->pyrocms_quick_links == 'yes') : ?>
	<div class="one_full">
		...
		<section id="quick_links" class="item <?php echo isset($rss_items) ?>">
			<div class="content">
				<ul>
					<li> <h4>fdgdgdfgdfgf</h4>
						<a class="tooltip-s" title="<?php echo lang('cp:manage_comments') ?>" href="<?php echo site_url('admin/comments') ?>">
							Advert Software System.
						
						</a>
					</li>
					<?php if(isset($do_not_show) AND (array_key_exists('comments', $this->permissions) OR $this->current_user->group == 'admin') AND module_enabled('comments')): ?>
					<li>
					...
					<?php if(isset($do_not_show) AND (array_key_exists('pages', $this->permissions) OR $this->current_user->group == 'admin') AND module_enabled('pages')): ?>
					<li>
					...
					<?php if(isset($do_not_show) AND (array_key_exists('files', $this->permissions) OR $this->current_user->group == 'admin') AND module_enabled('files')): ?>
					<li>
					...
					<?php if(isset($do_not_show) AND array_key_exists('users', $this->permissions) OR $this->current_user->group == 'admin'): ?>
					<li>
	...
	<?php if (isset($do_not_show_comments) AND isset($recent_comments) AND is_array($recent_comments) AND $theme_options->pyrocms_recent_comments == 'yes') : ?>
	<div class="one_full">
	...
	<?php if (isset($do_not_show) AND (isset($analytic_visits) OR isset($analytic_views)) AND $theme_options->pyrocms_analytics_graph == 'yes'): ?>
	...
	<!-- Begin RSS Feed -->
	<?php if (isset($do_not_show) AND  isset($rss_items) AND $theme_options->pyrocms_news_feed == 'yes') : ?>
