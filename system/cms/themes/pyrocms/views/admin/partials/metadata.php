...
<script type="text/javascript">
	...
	var RENT_TENURE_AGREEMENT = <?php echo RENT_TENURE_AGREEMENT; ?>;
	var MC_TENURE_AGREEMENT = <?php echo MC_TENURE_AGREEMENT; ?>;
	var PAYMENT_IN   = <?php echo PAYMENT_IN; ?>;
	var PAYMENT_OUT  =	<?php echo PAYMENT_OUT; ?>;
</script>
...
<style>section#content {margin-top: 130px!important;}</style>
<?php endif; ?>
